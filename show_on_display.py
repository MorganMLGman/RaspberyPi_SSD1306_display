...
def update_screen(sc):
    ...
    freq_screen = update_data(get_sys_info.get_arm_freq)
    ...
    screen.paste(freq_screen, (temp_screen.size[0] + 5,  clock_screen.size[1] + cpu_screen.size[1] * 3 + font_data_offset_v * 3 + font_clock_offset_v - 1))
